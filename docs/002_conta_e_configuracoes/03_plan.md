...
- [ ] **T5.2** `[frente B]` — Registrar o par Client ID/Secret da Pluggy como env da stack local e do Coolify, e documentar em `docs/deploy/coolify.md`. · camada **infra** · `especialista-infra`
