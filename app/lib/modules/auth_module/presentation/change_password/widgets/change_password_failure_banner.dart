...
class ChangePasswordFailureBanner extends StatelessWidget {
  const ChangePasswordFailureBanner({required this.failure, super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return Semantics(
      ...
      container: true,
      child: Container(
        key: const Key('change-password-failure-banner'),
