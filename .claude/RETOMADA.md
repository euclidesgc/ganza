...
- **Último gate/veredito**: faxina geral mergeada pelos PRs #59 e #60, CI inteiro verde — 212 testes do app, 159 do Deno, `gates_guard`, `verify-gauntlet` e `lint-dod` em `exit=0`.
