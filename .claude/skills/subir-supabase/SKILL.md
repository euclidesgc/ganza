...
> **Backup não é escopo** (decisão D4 do `docs/decisions.md`). Não inclua rotina de `pg_dump` no checklist nem sugira uma — o humano já decidiu.
